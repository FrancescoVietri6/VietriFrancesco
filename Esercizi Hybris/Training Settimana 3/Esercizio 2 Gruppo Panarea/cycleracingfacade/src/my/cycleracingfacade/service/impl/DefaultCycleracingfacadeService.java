...
public class DefaultCycleracingfacadeService implements CycleracingfacadeService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultCycleracingfacadeService.class);
	...
	{
		return DefaultCycleracingfacadeService.class.getResourceAsStream("/cycleracingfacade/sap-hybris-platform.png");
	}
