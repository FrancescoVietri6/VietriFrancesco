...
/**
 * This is the extension manager of the Cycleracingfacade extension.
 */
public class CycleracingfacadeManager extends GeneratedCycleracingfacadeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(CycleracingfacadeManager.class);
	 ...
	 */
	public static CycleracingfacadeManager getInstance()
	{
		return (CycleracingfacadeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(CycleracingfacadeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CycleracingfacadeManager() // NOPMD 
	{
		LOG.debug("constructor of CycleracingfacadeManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of CycleracingfacadeManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of CycleracingfacadeManager called, current tenant: {}", getTenant().getTenantID());
	}
