 ...
 */
package my.cycleracingcontroller.jalo;
...
/**
 * This is the extension manager of the Cycleracingcontroller extension.
 */
public class CycleracingcontrollerManager extends GeneratedCycleracingcontrollerManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(CycleracingcontrollerManager.class);
	 ...
	 */
	public static CycleracingcontrollerManager getInstance()
	{
		return (CycleracingcontrollerManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(CycleracingcontrollerConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CycleracingcontrollerManager() // NOPMD 
	{
		LOG.debug("constructor of CycleracingcontrollerManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of CycleracingcontrollerManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of CycleracingcontrollerManager called, current tenant: {}", getTenant().getTenantID());
	}
