...
public class DefaultCycleracingcontrollerService implements CycleracingcontrollerService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultCycleracingcontrollerService.class);
	...
	{
		return DefaultCycleracingcontrollerService.class.getResourceAsStream("/cycleracingcontroller/sap-hybris-platform.png");
	}
