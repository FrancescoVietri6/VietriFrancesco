...
public class DefaultHospitalcoreService implements HospitalcoreService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultHospitalcoreService.class);
	...
	{
		return DefaultHospitalcoreService.class.getResourceAsStream("/hospitalcore/sap-hybris-platform.png");
	}
