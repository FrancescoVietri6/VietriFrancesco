...
/**
 * This is the extension manager of the Hospitalcore extension.
 */
public class HospitalcoreManager extends GeneratedHospitalcoreManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(HospitalcoreManager.class);
	 ...
	 */
	public static HospitalcoreManager getInstance()
	{
		return (HospitalcoreManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(HospitalcoreConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public HospitalcoreManager() // NOPMD 
	{
		LOG.debug("constructor of HospitalcoreManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of HospitalcoreManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of HospitalcoreManager called, current tenant: {}", getTenant().getTenantID());
	}
