...
public class DefaultHospitalfacadeService implements HospitalfacadeService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultHospitalfacadeService.class);
	...
	{
		return DefaultHospitalfacadeService.class.getResourceAsStream("/hospitalfacade/sap-hybris-platform.png");
	}
