 ...
 */
package my.hospitalfacade.jalo;
...
/**
 * This is the extension manager of the Hospitalfacade extension.
 */
public class HospitalfacadeManager extends GeneratedHospitalfacadeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(HospitalfacadeManager.class);
	 ...
	 */
	public static HospitalfacadeManager getInstance()
	{
		return (HospitalfacadeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(HospitalfacadeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public HospitalfacadeManager() // NOPMD 
	{
		LOG.debug("constructor of HospitalfacadeManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of HospitalfacadeManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of HospitalfacadeManager called, current tenant: {}", getTenant().getTenantID());
	}
