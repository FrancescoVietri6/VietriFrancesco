...
public class DefaultCycleracingcoreService implements CycleracingcoreService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultCycleracingcoreService.class);
	...
	{
		return DefaultCycleracingcoreService.class.getResourceAsStream("/cycleracingcore/sap-hybris-platform.png");
	}
