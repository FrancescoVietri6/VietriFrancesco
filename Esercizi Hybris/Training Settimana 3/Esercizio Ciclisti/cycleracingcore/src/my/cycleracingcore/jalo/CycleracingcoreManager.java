...
/**
 * This is the extension manager of the Cycleracingcore extension.
 */
public class CycleracingcoreManager extends GeneratedCycleracingcoreManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(CycleracingcoreManager.class);
	 ...
	 */
	public static CycleracingcoreManager getInstance()
	{
		return (CycleracingcoreManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(CycleracingcoreConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CycleracingcoreManager() // NOPMD 
	{
		LOG.debug("constructor of CycleracingcoreManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of CycleracingcoreManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of CycleracingcoreManager called, current tenant: {}", getTenant().getTenantID());
	}
