 ...
 */
package my.cyclistfrontend.jalo;
...
/**
 * This is the extension manager of the Cyclistfrontend extension.
 */
public class CyclistfrontendManager extends GeneratedCyclistfrontendManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(CyclistfrontendManager.class);
	 ...
	 */
	public static CyclistfrontendManager getInstance()
	{
		return (CyclistfrontendManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(CyclistfrontendConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CyclistfrontendManager() // NOPMD 
	{
		LOG.debug("constructor of CyclistfrontendManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of CyclistfrontendManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of CyclistfrontendManager called, current tenant: {}", getTenant().getTenantID());
	}
