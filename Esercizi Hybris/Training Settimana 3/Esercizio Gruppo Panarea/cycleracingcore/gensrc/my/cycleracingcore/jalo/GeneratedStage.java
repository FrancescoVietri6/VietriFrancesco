...
public abstract class GeneratedStage extends GenericItem
{
	...
	/** Qualifier of the <code>Stage.stageRanking</code> attribute **/
	...
	**/
	...
	/**
	* {@link OneToManyHandler} for handling 1:n STAGERANKING's relation attributes from 'many' side.
	**/
	protected static final OneToManyHandler<StageRanking> STAGERANKINGHANDLER = new OneToManyHandler<StageRanking>(
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>Stage.stageRanking</code> attribute.
	 * @return the stageRanking
	 */
	public Collection<StageRanking> getStageRanking(final SessionContext ctx)
	{
		return STAGERANKINGHANDLER.getValues( ctx, this );
	}
	 ...
	 * @return the stageRanking
	 */
	public Collection<StageRanking> getStageRanking()
	{
		return getStageRanking( getSession().getSessionContext() );
	}
	
	/**
	 * <i>Generated method</i> - Setter of the <code>Stage.stageRanking</code> attribute. 
	 * @param value the stageRanking
	 */
	public void setStageRanking(final SessionContext ctx, final Collection<StageRanking> value)
	{
		STAGERANKINGHANDLER.setValues( ctx, this, value );
	}
	 ...
	 * @param value the stageRanking
	 */
	public void setStageRanking(final Collection<StageRanking> value)
	{
		setStageRanking( getSession().getSessionContext(), value );
	}
	
	/**
	 * <i>Generated method</i> - Adds <code>value</code> to stageRanking. 
	 * @param value the item to add to stageRanking
	 */
	public void addToStageRanking(final SessionContext ctx, final StageRanking value)
	{
		STAGERANKINGHANDLER.addValue( ctx, this, value );
	}
	 ...
	 * @param value the item to add to stageRanking
	 */
	public void addToStageRanking(final StageRanking value)
	{
		addToStageRanking( getSession().getSessionContext(), value );
	}
	
	/**
	 * <i>Generated method</i> - Removes <code>value</code> from stageRanking. 
	 * @param value the item to remove from stageRanking
	 */
	public void removeFromStageRanking(final SessionContext ctx, final StageRanking value)
	{
		STAGERANKINGHANDLER.removeValue( ctx, this, value );
	}
	 ...
	 * @param value the item to remove from stageRanking
	 */
	public void removeFromStageRanking(final StageRanking value)
	{
		removeFromStageRanking( getSession().getSessionContext(), value );
	}
