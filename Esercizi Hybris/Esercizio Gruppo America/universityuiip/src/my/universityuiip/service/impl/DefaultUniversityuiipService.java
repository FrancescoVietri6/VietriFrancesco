...
public class DefaultUniversityuiipService implements UniversityuiipService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultUniversityuiipService.class);
	...
	{
		return DefaultUniversityuiipService.class.getResourceAsStream("/universityuiip/sap-hybris-platform.png");
	}
