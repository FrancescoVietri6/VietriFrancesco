...
/**
 * This is the extension manager of the Universityuiip extension.
 */
public class UniversityuiipManager extends GeneratedUniversityuiipManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(UniversityuiipManager.class);
	 ...
	 */
	public static UniversityuiipManager getInstance()
	{
		return (UniversityuiipManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(UniversityuiipConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public UniversityuiipManager() // NOPMD 
	{
		LOG.debug("constructor of UniversityuiipManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of UniversityuiipManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of UniversityuiipManager called, current tenant: {}", getTenant().getTenantID());
	}
