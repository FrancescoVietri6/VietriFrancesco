...
public class DefaultCycleracinguiipfacadesService implements CycleracinguiipfacadesService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultCycleracinguiipfacadesService.class);
	...
	{
		return DefaultCycleracinguiipfacadesService.class.getResourceAsStream("/cycleracinguiipfacades/sap-hybris-platform.png");
	}
