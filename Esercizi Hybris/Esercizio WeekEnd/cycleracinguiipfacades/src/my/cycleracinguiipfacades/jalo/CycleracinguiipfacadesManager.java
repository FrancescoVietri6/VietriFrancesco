 ...
 */
package my.cycleracinguiipfacades.jalo;
...
/**
 * This is the extension manager of the Cycleracinguiipfacades extension.
 */
public class CycleracinguiipfacadesManager extends GeneratedCycleracinguiipfacadesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(CycleracinguiipfacadesManager.class);
	 ...
	 */
	public static CycleracinguiipfacadesManager getInstance()
	{
		return (CycleracinguiipfacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(CycleracinguiipfacadesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CycleracinguiipfacadesManager() // NOPMD 
	{
		LOG.debug("constructor of CycleracinguiipfacadesManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of CycleracinguiipfacadesManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of CycleracinguiipfacadesManager called, current tenant: {}", getTenant().getTenantID());
	}
