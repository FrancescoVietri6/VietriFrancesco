 ...
 */
package my.cycleracinguiipfacades.controller;
...
@Controller
public class CycleracinguiipfacadesHelloController
{
	@Autowired
	...
	{
		model.addAttribute("logoUrl", cycleracinguiipfacadesService.getHybrisLogoUrl(PLATFORM_LOGO_CODE));
		return "welcome";
	}
}
