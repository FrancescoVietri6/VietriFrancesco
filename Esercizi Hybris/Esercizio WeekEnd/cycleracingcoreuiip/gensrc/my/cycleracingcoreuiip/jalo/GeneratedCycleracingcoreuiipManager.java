...
/**
 * Generated class for type <code>CycleracingcoreuiipManager</code>.
 */
@SuppressWarnings({"deprecation","unused","cast","PMD"})
public abstract class GeneratedCycleracingcoreuiipManager extends Extension
{
	...
	public Cyclist createCyclist(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( CycleracingcoreuiipConstants.TC.CYCLIST );
	...
	public CyclistRanking createCyclistRanking(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( CycleracingcoreuiipConstants.TC.CYCLISTRANKING );
	...
	public Stage createStage(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( CycleracingcoreuiipConstants.TC.STAGE );
	...
	public StageRace createStageRace(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( CycleracingcoreuiipConstants.TC.STAGERACE );
	...
	public StageRanking createStageRanking(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( CycleracingcoreuiipConstants.TC.STAGERANKING );
	...
	{
		return CycleracingcoreuiipConstants.EXTENSIONNAME;
	}
