...
/**
 * This is the extension manager of the Cycleracingcoreuiip extension.
 */
public class CycleracingcoreuiipManager extends GeneratedCycleracingcoreuiipManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(CycleracingcoreuiipManager.class);
	 ...
	 */
	public static CycleracingcoreuiipManager getInstance()
	{
		return (CycleracingcoreuiipManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(CycleracingcoreuiipConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CycleracingcoreuiipManager() // NOPMD 
	{
		LOG.debug("constructor of CycleracingcoreuiipManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of CycleracingcoreuiipManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of CycleracingcoreuiipManager called, current tenant: {}", getTenant().getTenantID());
	}
