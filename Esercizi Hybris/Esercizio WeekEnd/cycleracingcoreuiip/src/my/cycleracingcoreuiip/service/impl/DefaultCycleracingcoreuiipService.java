...
public class DefaultCycleracingcoreuiipService implements CycleracingcoreuiipService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultCycleracingcoreuiipService.class);
	...
	{
		return DefaultCycleracingcoreuiipService.class.getResourceAsStream("/cycleracingcoreuiip/sap-hybris-platform.png");
	}
